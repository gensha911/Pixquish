...
// Dynamically resolves to the production domain or the current Vercel deployment.
...
export const metadata: Metadata = {
  ...
  description:
    "Pixquish is a 100% browser-based image compressor and resizer — your images never leave your device. Read our full privacy policy for details on data handling, cookies, and retention.",
  alternates: {
    canonical: `${siteUrl}/privacy`,
  },
  openGraph: {
    title: "Privacy Policy · Pixquish",
    description:
      "Pixquish processes images entirely in your browser. No uploads, no server-side storage. Read our privacy policy.",
    url: `${siteUrl}/privacy`,
    type: "article",
    siteName: "Pixquish",
  },
  twitter: {
    ...
    title: "Privacy Policy · Pixquish",
    description:
      "Pixquish processes images entirely in your browser. No uploads, no server-side storage.",
  },
  robots: {
    index: true,
    follow: true,
...
<p>Pixquish is a free, browser-based image compressor and resizer. <strong>Your images never leave your device</strong> — all compression and resizing happens locally in your browser using the Canvas API. We do not operate a server that receives, stores, or processes your image files.</p>
...
<li>
<p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Pixquish.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to Pixquish, accessible from <a href="https://pixquish.app" rel="external noopener" target="_blank">https://pixquish.app</a>.</p>
</li>
<li>
...
<ul>
<li>
<p>By email: gensha911@gmail.com</p>
</li>
<li>
<p>By visiting this page on our website: <a href="https://pixquish.app/privacy" rel="external noopener" target="_blank">https://pixquish.app/privacy</a></p>
</li>
</ul>
`;
...
export default function PrivacyPolicy() {
  return (
    <main
      className="max-w-4xl mx-auto px-6 py-12 prose dark:prose-invert"
